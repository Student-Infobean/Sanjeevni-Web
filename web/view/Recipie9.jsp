<%-- 
    Document   : Recipie9
    Created on : Nov 28, 2023, 12:10:58 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">Tuna Salad with Egg</h2>
            <p class="fs-5 mt-4">This simple tuna salad with egg has a clean and balanced flavor. The capers and lemon bring acidity to help everything come together and chopped arugula adds a peppery kick. Enjoy it with greens or on a slice of your favorite whole-grain bread.</p>

            <img class="img-fluid mt-5 h-30" src="images/Recipe9.webp" alt="" width="50%" height="300px" style="overflow: hidden;">
            <div class="col w-50 p-5 mt-5" style="background-color: rgb(228,241,239);">
              ...
              <span class="mt-4 ms-5"></span> <br><br>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul fs-5">
                ...
                <li>½ cup coarsely chopped arugula</li>
                <li>¼ cup mayonnaise</li>
                <li>¼ cup thinly sliced scallions, white and light green parts only</li>
                <li>¼ cup whole-milk plain Greek yogurt</li>
                <li>1 teaspoon grated lemon zest</li>
                <li>2 tablespoons lemon juice</li>
                <li>1 ½ tablespoons capers, rinsed</li>
                <li>½ teaspoon dried tarragon, rubbed</li>
                <li>2 (5 ounce) cans solid white tuna in water, drained</li>
                <li>2 hard-boiled eggs, chopped</li>
            
            </ul>
            <h2 class="fw-bold mt-5">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Stir celery, arugula, mayonnaise, scallions, yogurt, lemon zest, lemon juice, capers and tarragon together in a medium bowl until well combined. Gently fold in tuna and eggs. Serve over salad greens or on sandwich bread, if desired.</p>
            ...
            <span class="mt-4 fw-bold me-5">247</span>
            <span class="mt-4 fw-bold me-5 ms-5">16g</span>
            <span class="mt-4 fw-bold ms-5">3g</span>
