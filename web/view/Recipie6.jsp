<%-- 
    Document   : Recipie6
    Created on : Nov 28, 2023, 12:09:54 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">Creamy Cucumber, Radish & Tomato Chopped Salad</h2>
            <p class="fs-5 mt-4">A mix of cool, crunchy vegetables gives this healthy salad satisfying bite for a perfect potluck side.</p>

            <img class="img-fluid mt-5 h-30" src="images/Recipe6.webp" alt="" width="50%" height="300px" style="overflow: hidden;">
            <div class="col w-50 p-5 mt-5" style="background-color: rgb(228,241,239);">
              ...
              <ul class="list-inline " >
                <li class="list-inline-item" id="items"><a href="#">Low-Carb</a></li>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul fs-5">
                ...
                <li>1 tablespoon chopped fresh chives, plus more for garnish</li>
                <li>1 tablespoon chopped fresh dill, plus more for garnish</li>
                <li>1 tablespoon lemon juice</li>
                <li>¼ teaspoon salt</li>
                <li>¼ teaspoon ground pepper</li>
                <li>1 large English cucumber, diced</li>
            ...
            <p class="fs-5">Whisk mayonnaise, feta, chives, dill, lemon juice, salt and pepper in a large bowl. Add cucumber, tomatoes, radishes and onion and toss to coat. Garnish with more chives and dill, if desired.</p>
            ...
            <span class="mt-4 fw-bold me-5">187</span>
            <span class="mt-4 fw-bold me-5 ms-5">17g</span>
