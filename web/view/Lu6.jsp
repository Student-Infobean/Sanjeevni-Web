<%-- 
    Document   : Lu6
    Created on : Nov 27, 2023, 11:50:58 PM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Rainbow Grain Bowl with Cashew Sauce</h2>
            <p class="fs-5">This vibrant bowl is packed with nutrients to keep you full for hours. Look for precooked lentils in the refrigerated section of the produce department.</p>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              <li>¾ cup unsalted cashews</li>
              <li>½ cup water</li>
              <li> ¼ cup packed parsley leaves </li>
              <li>1 tablespoon lemon juice or cider vinegar</li>
              <li>1 tablespoon extra-virgin olive oil</li>
              <li>½ teaspoon reduced-sodium tamari or soy sauce (see Tip)           </li>
              <li>¼ teaspoon salt</li>
              <li>½ cup cooked lentils</li>
              <li>½ cup cooked quinoa</li>
              <li>½ cup shredded red cabbage</li>
              <li>¼ cup grated raw beet</li>
              <li>¼ cup chopped bell pepper</li>
              <li>¼ cup grated carrot</li>
              <li>¼ cup sliced cucumber</li>
              <li>1 tablespoon Toasted chopped cashews for garnish </li>
            </ul>
            <h2 class="fw-bold">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Blend cashews, water, parsley, lemon juice (or vinegar), oil, tamari (or soy sauce) and salt in a blender until smooth.</p>
    
            <h5 class="mt-4 fw-bold">Step 2 </h5>
            <p class="fs-5">Place lentils and quinoa in the center of a shallow serving bowl. Top with cabbage, beet, pepper, carrot and cucumber. Spoon 2 tablespoons of the cashew sauce over the top (save extra sauce for another use). Garnish with cashews, if desired. </p>
            <img class="img-fluid" src="images/L24.webp" width="50%" alt="">
