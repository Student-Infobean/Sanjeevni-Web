<%-- 
    Document   : Lu17
    Created on : Nov 27, 2023, 11:54:37 PM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Bell Pepper & Feta Chickpea Salad</h2>
            <p class="fs-5">This easy no-cook chickpea salad comes together quickly, making it the perfect choice on busy days. Red-wine vinegar brightens the dish, while feta adds a tangy, slightly salty flavor.</p>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <p class="fs-5">Whisk oil, vinegar and Italian seasoning in a medium bowl. Add chickpeas, parsley, bell pepper and olives; toss to coat. Sprinkle with feta.</p>
