<%-- 
    Document   : Lu13
    Created on : Nov 27, 2023, 11:53:09 PM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Meal-Prep Chili-Lime Chicken Bowls</h2>
            <p class="fs-5">Skip takeout and whip up these equally delicious and easy-to-make burrito bowls at home. They're great for a fast and easy dinner or a healthy meal to pack for work throughout the week.</p>
            <img class="img-fluid" src="images/L31.webp" width="50%" alt="">
            ...
            <h2 class="mt-4 fw-bold">How to Prep Your Ingredients</h2>
            <p class="fs-5">The key to successful meal prepping is having all of your ingredients measured, peeled, chopped and cooked before assembling into containers. Follow these easy steps for prepping your ingredients: <br><br></p>
            <h5 class="mt-4 fw-bold">Cook the Quinoa  </h5>
            <p class="fs-5">Quinoa is a quick-cooking whole grain with a nutty taste. This step-by-step guide with photos shows you how to cook quinoa 3 different ways: on the stovetop, in a rice cooker and in the Instant Pot. </p>
            
            <h5 class="mt-4 fw-bold">Cook the Brown Rice  </h5>
            <p class="fs-5">A simple ratio is all you need to make perfect brown rice every time: 1 cup of brown rice to 2 1/2 cups of water. Follow our method on how to cook brown rice perfectly on the stovetop. You can also use instant brown rice to save time. </p>
       
            <h5 class="mt-4 fw-bold">Make the Chili-Lime Chicken   </h5>
            <p class="fs-5">This easy chili-lime chicken takes about 15 to 18 minutes to cook in the oven. The chicken is roasted on a foil-lined baking sheet, making cleanup a breeze after cooking. </p>

            <h5 class="mt-4 fw-bold">Julienne the Jicama </h5>
            <!-- <h5 class="mt-4 fw-bold">Why Do You Have to Massage Kale for Salad? </h5> -->
            <p class="fs-5">Jicama is a nutrient-dense root vegetable that's sweet and crunchy. You'll need to cut off the thick brown skin using a sharp knife (a vegetable peeler likely won't cut deep enough) before cutting. To julienne jicama, slice them into rounds about 1/4-inch thick, stack about 3 to 4 rounds, then slice the rounds into thin, matchstick-sized pieces. </p>
            
            <h5 class="mt-4 fw-bold">How to Serve  </h5>
            <p class="fs-5">To reheat, microwave on High until warm. Serve with diced avocado, lime wedges and hot sauce. </p>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              ...
              <li>1 pound cooked Chili-Lime Chicken (see Associated recipe)</li>
              <li>1 cup julienned jicama</li>
             <li>1 cup frozen corn, thawed</li>
             <li>1 cup pico de gallo
            </li>
             <li>1 avocado, diced
            </li>
             ...
             <li>Lime wedges</li>
             <li>Hot sauce, such as Cholula</li>
            
            </ul>
            <h2 class="fw-bold">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Combine quinoa and rice; divide among 4 single-serving containers with lids. Top with chicken, jicama, corn, pico de gallo and cilantro, dividing evenly. Seal the containers and refrigerate for up to 4 days. Serve with diced avocado, lime wedges and hot sauce.</p>
    
            <h5 class="mt-4 fw-bold">To Make Ahead  </h5>
            <p class="fs-5">Refrigerate covered containers for up to 4 days. </p>
