<%-- 
    Document   : Thise39
    Created on : Nov 28, 2023, 12:35:49 AM
    Author     : Lenovo
--%>
        ...
        <div class="col w-100">
            ...
            <ul class="ul">
             ...
             <!-- <li>1 ½ cups shredded extra-sharp Cheddar cheese, divided</li> -->
              <li>1 ½ pounds Brussels sprouts, trimmed, halved or quartered if large</li>
              <li>2 slices bacon, chopped</li>
            </ul>
            <h2 class="fw-bold">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Preheat oven to 400°F. Line a large rimmed baking sheet with parchment paper.
            ...
            <p class="fs-5">Mix oil, maple syrup, salt and pepper in a large bowl. Add Brussels sprouts and toss to coat, Spread in an even layer on the prepared baking sheet. Roast, stirring halfway, until crispy and golden, 15 to 20 minutes. Transfer to a large platter.
            </p> 
            ...
            <p class="fs-5">Meanwhile, add bacon to a small skillet over medium heat. Cook, stirring, until crispy, about 5 minutes. Remove with a slotted spoon to a paper-towel-lined plate.
