<%-- 
    Document   : Recipie7
    Created on : Nov 28, 2023, 12:10:16 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">Kale, Quinoa & Apple Salad</h2>
            <p class="fs-5 mt-4">This kale, quinoa and apple salad is perfect for fall. Fresh apples bring crisp autumn flavor, and the kale breaks down when it's massaged with the dressing. Nuts, fennel and quinoa add more layers of texture, while blue cheese lends a savory note.</p>

            <img class="img-fluid mt-5 h-30" src="images/Recipe7.webp" alt="" width="50%" height="300px" style="overflow: hidden;">
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul fs-5">
                ...
                <li>1 large bunch curly kale, stemmed and thinly sliced (about 8 cups)</li>
                <li>2 medium Honeycrisp or Gala apples, unpeeled, roughly chopped</li>
                <li>1 medium fennel bulb, cored and thinly sliced (3 cups)</li>
                <li>2 cups cooked quinoa, at room temperature or chilled</li>
                <li>½ cup slivered almonds, toasted (see Tip)</li>
            ...
            <p class="fs-5">Whisk vinegar, maple syrup, salt and pepper together in a large bowl. Slowly drizzle in oil, whisking until combined. Add kale and massage into the dressing with clean hands until well coated and slightly tender, 3 to 5 minutes. Add apples, fennel and quinoa; toss until combined. Divide among 4 plates and top with almonds, cherries and blue cheese.</p>
            ...
            <span class="mt-4 fw-bold me-5">499</span>
            <span class="mt-4 fw-bold me-5 ms-5">27g</span>
            <span class="mt-4 fw-bold ms-5">54g</span>
            <span class="mt-4 fw-bold ms-5 ps-2">13g</span> <br>
