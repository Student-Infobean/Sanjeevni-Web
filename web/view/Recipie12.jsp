<%-- 
    Document   : Recipie12
    Created on : Nov 28, 2023, 12:11:57 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">Mason Jar Power Salad with Chickpeas & Tuna</h2>
            <p class="fs-5 mt-4">This power salad will keep you fueled for hours, thanks to 26 grams of protein and 8 grams of fiber. Tossing the dressing and kale, and then letting it stand in the jar, softens it enough so you don't need to massage or cook it to make it tender.</p>

            <img class="img-fluid mt-5 h-30" src="images/Recipe12.webp" alt="" width="50%" height="300px" style="overflow: hidden;">
            <div class="col w-50 p-5 mt-5" style="background-color: rgb(228,241,239);">
              ...
              <span class="mt-4 me-5 pe-4" >5 mins</span>
              <span class="mt-4 me-5 ms-5 pe-5">5 mins</span>
              ...
              <ul class="list-inline " >
                ...
                <li class="list-inline-item" id="items"><a href="#">High-Blood Pressure</a></li>
  ...
  <div class="container my-5  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul fs-5">
                <li>3 cups bite-sized pieces chopped kale</li>
                <li>2 tablespoons honey-mustard vinaigrette (see associated recipe)</li>
                <li>1 2.5-ounce pouch tuna in water</li>
                <li>½ cup rinsed canned chickpeas</li>
                <li>1 carrot, peeled and shredded</li>
            
            </ul>
            <h2 class="fw-bold mt-5">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Toss kale and dressing in a bowl, then tranfer to a 1-quart mason jar. Top with tuna, chickpeas and carrot. Screw lid onto the jar and refrigerate for up to 2 days.</p>
            <h5 class="mt-4 fw-bold">Step 2 </h5>
            <p class="fs-5">To serve, empty the jar contents into a bowl and toss to combine the salad ingredients with the dressed kale.</p>
            <h2 class="mt-4 fw-bold">To make ahead</h2>
            <p class="fs-5">Refrigerate for up to 2 days.<p>
                <h2 class="mt-4 fw-bold">Equipment</h2>
                <p class="fs-5">!-quart manson jar<p>
            ...
            <span class="mt-4 fw-bold me-5">430</span>
            <span class="mt-4 fw-bold me-5 ms-5">23g</span>
            <span class="mt-4 fw-bold ms-5">30g</span>
            <span class="mt-4 fw-bold ms-5 ps-2">26g</span> <br>
