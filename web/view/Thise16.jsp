<%-- 
    Document   : Thise16
    Created on : Nov 28, 2023, 12:28:36 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Tres Leches-Inspired Overnight Oats</h2>
            <p class="fs-5">Tres leches, which is Spanish for "three milks," gets its name from the three types of milk that are used to soak the classic cake: whole milk, evaporated milk and sweetened condensed milk. Here, we use those milks to hydrate oats, creating a creamy, satisfying breakfast. A sprinkle of cinnamon adds a nice touch of spice, while sliced strawberries provide a pop of color. Tres leches cake is usually topped with whipped cream—if you want to re-create that creaminess, try topping these oats with some plain yogurt for a breakfast-friendly twist.</p>
            <img class="img-fluid" src="https://www.eatingwell.com/thmb/UUpppcq0S88B5IkECSO480s8ni4=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/EWL-Tres-Leches-Inspired-Overnight-Oats-Beauty-246-2000-1dc400e7af8d4f69a00b36afd8d4f62a.jpg" alt="">
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              ...
              <li>1 cup whole evaporated milk</li>
              <li>3 tablespoons sweetened condensed milk plus 2 teaspoons, divided</li>
            ...
            <p class="fs-5">Whisk whole milk, evaporated milk, 3 tablespoons condensed milk, chia seeds, vanilla and salt together in a medium bowl until fully combined. Fold in oats.
            </p>
            ...
            <p class="fs-5">Spoon 3/4 cup of the oat mixture into each of 4 (8-oz.) jars. Cover and refrigerate for at least 8 hours and up to 4 days.


            </p>
            <h5 class="mt-4 fw-bold">Step 3</h5>
            <p class="fs-5">Just before serving, drizzle each jar of oats with 1/2 teaspoon condensed milk. Sprinkle with cinnamon; top each jar with 2 tablespoons strawberries. Serve chilled.
