<%-- 
    Document   : Thise33
    Created on : Nov 28, 2023, 12:33:51 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Ingredient Maple Chipotle Roasted Sweet Potatoes</h2>
            <p class="fs-5">This easy side is sweet and smoky, thanks to the combination of maple syrup and adobo sauce from a can of chipotle chile peppers. If you have leftover chipotles, freeze them along with the adobo sauce in an ice cube tray and then thaw out a cube as needed. If you love the flavor of chipotles and want to take the heat up a notch, you can chop a chile and toss the roasted potatoes with it right before serving.</p>
            <img class="img-fluid" src="https://www.eatingwell.com/thmb/13TFTV-98vl55Wz-rMymvgi__M4=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/maple-chipotle-roasted-sweet-potatoes-2x3-8178-2000-3d09a4e782644af6b43ba5aa40e43b56.jpg" alt="">
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              <li>2 pounds sweet potatoes, scrubbed and cut into 1-inch chunks</li>
             ...
             <!-- <li>1 ½ cups shredded extra-sharp Cheddar cheese, divided</li> -->
              <li>1 ½ tablespoons adobo sauce from a can of chipotle chiles </li> 
            ...
            <p class="fs-5">Preheat oven to 425°F.
            ...
            <p class="fs-5">Toss sweet potatoes in a large bowl with oil, salt and pepper. Spread evenly on a large rimmed baking sheet; roast, stirring once, until tender and starting to brown, 20 to 25 minutes.
            ...
            <p class="fs-5">Meanwhile, stir maple syrup and adobo sauce together in a small bowl.
            ...
            <p class="fs-5">Drizzle the sweet potatoes with the maple syrup mixture.
  </p> 
  <br>
    ...
    <div class="container-fluid">
        <div class="row row-cols-lg-4 row-cols-md-2 row-cols-1">
          <div class="col  ms-5 fw-bold  w-100">
            ...
            <div class="col">  
            <div class="card">
                <a href="Thise20.jsp" class="cap text-decoration-none">
