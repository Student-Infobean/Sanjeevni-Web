<%-- 
    Document   : Lu4
    Created on : Nov 27, 2023, 11:50:21 PM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Anti-Inflammatory Beet & Avocado Wrap</h2>
            <p class="fs-5">Packed with fiber and monounsaturated fats, avocados are one of the best foods to eat to fight inflammation. Combined with beets, which contain their own inflammation-fighting phytochemicals, you'll get a lunch that packs a healthy punch. The tahini-lemon mixture adds brightness and a nutty flavor to the wrap. To julienne beets, cut them into thin rounds, then slice the rounds into matchsticks. Or to save time, simply grate the beets on the largest holes of a box grater.</p>
            <img src="images/Lu24.webp" alt="">
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              ...
              <li>½ cup julienned red beets</li>
              <li>1 ½ tablespoons hummus</li>
              <li>1 (8 inch) whole-wheat tortilla</li>
              <li>2 leaves butter lettuce</li>
              <li>½ medium avocado, sliced</li>
              
            </ul>
            <h2 class="fw-bold">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Whisk lemon juice, tahini, oil, salt and pepper together in a medium bowl. Add beets; toss to coat. </p>
           

            
            <h5 class="mt-4 fw-bold">Step 2</h5>
            <p class="fs-5">Spread hummus evenly over 1 side of tortilla. Place lettuce over hummus; top with beet mixture and avocado slices. Roll up burrito-style; slice in half. </p>
