<%-- 
    Document   : Lu16
    Created on : Nov 27, 2023, 11:54:23 PM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Arugula & Cucumber Salad with Tuna</h2>
            <p class="fs-5">Spicy baby arugula pairs with crisp Persian cucumbers and celery in this refreshing salad. Italian Castelvetrano olives offer a mild, buttery flavor that doesn't compete with the flavor of the tuna. If you want more punch from your olives, Niçoise olives or Kalamata olives work well too.</p>
            <img class="img-fluid" src="images/l34.webp" width="50%" alt="">
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
             ...
             <li>¾ cup thinly sliced Persian or English cucumber</li>
             <li>1 (5 ounce) package baby arugula
            </li>
             <li>8 pitted Castelvetrano olives, quartered (about 1/3 cup)</li>
             <li>2 (6.7-ounce) packages no-salt-added tuna fillets in water, drained
            </li>
            
            </ul>
            <h2 class="fw-bold">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Whisk basil, vinegar, lemon juice and salt together in a large bowl. Add oil; whisk to combine. Add celery, cucumber, arugula and olives; toss to coat. </p>
            
            <h5 class="mt-4 fw-bold">Step 2</h5>
            <p class="fs-5">Divide among 4 bowls; flake tuna on top of each bowl. </p>
