<%-- 
    Document   : Thise18
    Created on : Nov 28, 2023, 12:29:12 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Raspberry Yogurt Cereal Bowl</h2>
            <p class="fs-5">For breakfast, snack or a healthy dessert, try using yogurt instead of milk for your cereal. If making this as a to-go snack, keep the cereal separate and top just before eating.</p>
            <img class="img-fluid" src="https://www.eatingwell.com/thmb/FHib1qs1_5lbUKI1hv2qTtSNZR4=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/4473423-f0d6fc7eebb4441abfe0908adb75a3e1.jpg" alt="">
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              ...
              <li>½ cup mini shredded-wheat cereal</li>
              <li>¼ cup fresh raspberries</li>
              <li>2 teaspoons mini chocolate chips</li>
             <li>1 teaspoon pumpkin seeds</li>
            ...
            <p class="fs-5">Place yogurt in a bowl and top with shredded wheat, raspberries, chocolate chips, pumpkin seeds and cinnamon.
