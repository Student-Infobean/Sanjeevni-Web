<%-- 
    Document   : Thise28
    Created on : Nov 28, 2023, 12:32:11 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Attention: This Roasted Cabbage Salad Is Seriously Good</h2>
            <p class="fs-5">Cabbage sweetens in the hot oven and is paired with a sharp, cheesy Caesar-like dressing for a deeply satisfying side dish that pairs well with roasted chicken, pork or steak. Don’t be tempted to squeeze all the cabbage onto one baking sheet. Spreading it out between two prevents the cabbage from steaming and helps it caramelize.</p>
            <img class="img-fluid" src="https://www.eatingwell.com/thmb/fe74Ik6vzuMl30vS_l1oyVAe0Og=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/RoastedCabbageSalad-3x2-143-211181f4e41d4003ad410d45e0571c52.jpg" alt="">
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              <li>1 small head green cabbage, chopped into 1-inch pieces (about 8 cups)</li>
             ...
             <li>1 large clove garlic, grated with a Microplane</li> 
              <li>1/4 teaspoon ground pepper, plus more for garnish </li>
            ...
            <p class="fs-5">Position oven racks in top third and lower third; preheat to 425°F. Toss cabbage with 2 tablespoons oil and salt in a large bowl until well coated. Spread in an even layer on 2 large rimmed baking sheets.
            ...
            <p class="fs-5">Roast the cabbage until tender and golden, about 25 minutes, rotating the pans between top and bottom racks halfway through.
            ...
            <p class="fs-5">Meanwhile, whisk Parmesan, vinegar, soy sauce, mustard, garlic, pepper and the remaining 2 tablespoons oil together in a large heatproof bowl. (For a creamier dressing, process in a blender until creamy and smooth, about 30 seconds.)
            </p> 
            ...
            <p class="fs-5">Transfer the hot roasted cabbage to the bowl with the dressing; toss until evenly coated. Let stand for 15 minutes to allow the flavors to meld. Garnish with additional pepper before serving, if desired.
  </p> 
