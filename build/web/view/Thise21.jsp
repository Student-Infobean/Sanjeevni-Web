<%-- 
    Document   : Thise21
    Created on : Nov 28, 2023, 12:30:08 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Loaded Broccoli Casserole</h2>
            <p class="fs-5">We take the traditional loaded baked potato toppings—bacon, Cheddar cheese and sour cream—and toss them with roasted broccoli instead. The result is a cheesy side dish that will have everyone rushing to eat their vegetables.</p>
            <img class="img-fluid" src="https://www.eatingwell.com/thmb/2bD7Ya9SSggTQNDJDAEnv8_e-SY=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/loaded-broccoli-casserole-317fb23f49ef4a9aa8ce6fb8a7b88326.jpg" alt="">
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              ...
              <li>1 ½ pounds broccoli crowns, cut into bite-size florets</li>
              <li>½ teaspoon ground pepper</li>
              <li>¼ teaspoon salt</li>
             <li>1 tablespoon extra-virgin olive oil (if needed)</li>
             <li>1 ½ cups shredded extra-sharp Cheddar cheese, divided</li>
              <li>⅔ cup reduced-fat sour cream</li> 
             <li>4 scallions, sliced, divided</li> 
            ...
            <p class="fs-5">Preheat oven to 425°F. Lightly coat a 9-by-13-inch baking dish with cooking spray.
            </p>
            ...
            <p class="fs-5">Place bacon in a large nonstick skillet over medium heat; cook until crisp, 6 to 8 minutes. Transfer to a paper-towel-lined plate to cool, then chop (reserve drippings in the pan).
