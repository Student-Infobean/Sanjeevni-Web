<%-- 
    Document   : Lu5
    Created on : Nov 27, 2023, 11:50:38 PM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col">
            <h5 class="First">Healthy Meat & Poultry Recipes > Healthy chicken Recipes > Healthy  chicken Main Dish Recipes > Healthy Buffalo chicken Recipes</h5>
        </div>
    </div>
  </div>
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Buffalo Chicken Grain Bowl</h2>
            <p class="fs-5">Get the flavors of spicy Buffalo chicken wings, without frying, in this nutritious couscous bowl loaded with protein and crisp veggies.</p>
            <img src="images/L23.webp" alt="">
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              <li>⅔ cup cooked whole-wheat couscous (see associated recipe)</li>
              <li>2 tablespoons honey-mustard vinaigrette, divided (see associated recipe)</li>
              <li> 1 roasted chicken thigh, sliced (see associated recipe)</li>
              <li>2 stalks celery, chopped </li>
              <li>1 carrot, peeled and cut into ribbons with a vegetable peeler            </li>
              <li>2 tablespoons crumbled blue cheese</li>
              <li>Hot sauce to taste</li>
            </ul>
            <h2 class="fw-bold">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Combine couscous and 1 tablespoon dressing a medium sealable container. Top with chicken, celery, carrot ribbons and blue cheese. Drizzle with the remaining 1 tablespoon dressing. Refrigerate for up to 5 days. Top with hot sauce just before serving. </p>
