<%-- 
    Document   : Recipie4
    Created on : Nov 28, 2023, 12:08:39 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">White Bean & Veggie Salad</h2>
            <p class="fs-5 mt-4">This meatless main-dish salad combines creamy, satisfying white beans and avocado. Try mixing it up with different seasonal vegetables.</p>

            <img class="img-fluid mt-5 h-30" src="images/Recipe4.webp" alt="" width="50%" height="300px" style="overflow: hidden;">
            <div class="col w-50 p-5 mt-5" style="background-color: rgb(228,241,239);">
              ...
              <span class="mt-4">4 servings</span><hr>
              <p class="fs-5 fw-bold">Nutritional Profile:<br><br></p>
              <ul class="list-inline " >
                <li id="items" class="list-inline-item"><a href="#" >Nut-Free</a></li>
                <li id="items" class="list-inline-item"><a href="#" >Dairy-Free</a></li>
                <li id="items" class="list-inline-item"><a href="#" >Healthy Pregnancy</a></li>
                <li id="items" class="list-inline-item"><a href="#" >Soy-Free</a></li>
                <li id="items" class="list-inline-item"><a href="#" >High-Fiber</a></li>
                <li id="items" class="list-inline-item"><a href="#" >Vegan</a></li>
                <li id="items" class="list-inline-item"><a href="#" >Vegetarian</a></li>
                <li id="items" class="list-inline-item"><a href="#" >Egg-Free</a></li>
                <li id="items" class="list-inline-item"><a href="#" >Gluten-Free</a></li>
                <li id="items" class="list-inline-item"><a href="#" >Low-Calorie</a></li>
              </ul>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul fs-5">
                ...
                <li>¾ cup veggies of your choice, such as chopped cucumbers and cherry tomatoes</li>
                <li>⅓ cup canned white beans, rinsed and drained</li>
                <li>½ avocado, diced</li>
            ...
            <p class="fs-5">Combine greens, veggies, beans and avocado in a medium bowl. Drizzle with vinegar and oil and season with salt and pepper. Toss to combine and transfer to a large plate.</p>
            <!-- <h2 class="mt-4 fw-bold">To make ahead</h2>
            <p class="fs-5">Refrigerate for up to 5 days.<p> -->
            ...
            <p class="fs-5 mt-5">Originally appeared: EatingWell.com, August 2017; updated November 2022</p>
            ...
            <span class="mt-4 fw-bold me-5">360</span>
            <span class="mt-4 fw-bold me-5 ms-5">25g</span>
            <span class="mt-4 fw-bold ms-5">30g</span>
            <span class="mt-4 fw-bold ms-5 ps-2">10g</span> <br>
