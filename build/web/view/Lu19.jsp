<%-- 
    Document   : Lu19
    Created on : Nov 27, 2023, 11:55:09 PM
    Author     : Lenovo
--%>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              ...
              <li>⅛ teaspoon ground pepper
              </li>
              <li>Pinch of salt</li>
             <li>⅔ cup lightly packed arugula
            </li>
             <li>1 teaspoon chopped fresh basil
            </li>
             <li>1 slice heirloom tomato, halved
            </li>
             <li>2 ounces burrata, halved
            </li>
             <li>2 slices ciabatta, toasted
            </li>
            </ul>
            <h2 class="fw-bold">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Whisk vinegar, oil, pepper and salt together in a medium bowl. Add arugula and basil; toss to coat. </p>
            
            <h5 class="mt-4 fw-bold">Step 2</h5>
            <p class="fs-5">Layer tomato, burrata and the arugula mixture on 1 slice of ciabatta. Drizzle with any remaining vinegar from the bowl; top with the other slice of ciabatta. Cut in half before serving.</p>
