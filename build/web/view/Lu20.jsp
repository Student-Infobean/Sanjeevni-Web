<%-- 
    Document   : Lu20
    Created on : Nov 27, 2023, 11:55:26 PM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">3-Ingredient Chicken Salad Tostadas</h2>
            <p class="fs-5">For this three-ingredient dinner, a premade salad kit is the perfect shortcut because it has everything you need in one bag, including the dressing. Swap in canned black beans for the chicken to make this vegetarian.</p>
            <img class="img-fluid" src="images/L38.webp" width="50%" alt="">
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              <li>1 (10 ounce) Southwest-style salad kit
            </li>
              <li>6 ounces rotisserie chicken breast, shredded
            </li>
              <li>6 tostada shells
            ...
            <p class="fs-5">Prepare salad kit according to package directions, reserving tortilla strips and shredded cheese; fold in chicken. Divide the chicken salad mixture among tostada shells. Top with the reserved tortilla strips and cheese.</p>
