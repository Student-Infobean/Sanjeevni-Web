<%-- 
    Document   : Lu12
    Created on : Nov 27, 2023, 11:52:55 PM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Cabbage, Tofu & Edamame Salad</h2>
            <p class="fs-5">Craving crunch? Bite into this salad loaded with crisp red cabbage, edamame, bamboo shoots, and chow mein noodles. This salad is slightly sweetened with baked tofu, mandarin oranges and sesame vinaigrette.</p>
            <img class="img-fluid" src="images/L30.webp" width="50%" alt="">
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              <li>4 cups mesclun</li>
              <li>½ cup shredded red cabbage</li>
              <li>3 ounces baked tofu cubes</li>
              <li>½ cup grated carrots</li>
             <li>½ cup edamame</li>
             <li>¼ cup mandarin oranges</li>
             <li>1 tablespoon golden raisins</li>
             <li>½ cup bamboo shoots</li>
             <li>2 tablespoons chow mein noodles</li>
             <li>2 tablespoons bottled reduced-sugar Asian sesame vinaigrette</li>
            
            </ul>
            <h2 class="fw-bold">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Mix mesclun, cabbage, tofu, carrots, edamame, oranges, raisins, bamboo shoots, and chow mein noodles in a medium bowl. Drizzle with vinaigrette. </p>
