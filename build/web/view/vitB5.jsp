<%-- 
    Document   : vitB5
    Created on : Nov 28, 2023, 12:43:15 AM
    Author     : Lenovo
--%>
      ...
      <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
        ...
        <div>
            <div class="container" style="background-color: rgb(222,243,224);">
                <div class="row row-cols-lg-2 row-cols-md-2 row-cols-sm-1 row-cols-1">
                    <div class="col">
                        <h3 class="fw-bold text-secondary">Pantothenic Acid – Vitamin B5</h3>
                        <p class="fs-5">Vitamin B5, or pantothenic acid, is naturally present in foods, added to foods, and available as a supplement. It is used to make coenzyme A (CoA), a chemical compound that helps enzymes to build and break down fatty acids as well as perform other metabolic functions, and acyl carrier protein, which is also involved in building fats. [1] Pantothenic acid is found in a wide variety of foods. Bacteria in the gut can also produce some pantothenic acid but not enough to meet dietary needs.
                        </p>
                    </div>
                    <div class="col">
                        <img class="img-fluid p-4 ms-5" src="images/v4.webp" width="400px" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container py-5" >
            <div class="row row-cols-lg-2 row-cols-md-2 row-cols-sm-1 row-cols-1" style="background-color:  rgb(245, 245, 245);" >
                ...
                <div class="col">
                    <ul class="fs-5">
                        <li ><b> RDA:</b>The Recommended Dietary Allowance (RDA) for men and women ages 19+ years is 5 mg daily. For pregnancy and lactation, the amount increases to 6 mg and 7 mg daily, respectively.</li>
                        <li><b>UL:</b>A Tolerable Upper Intake Level (UL) is the maximum daily dose unlikely to cause adverse side effects in the general population. A UL has not been established for pantothenic acid, because a toxic level has not been observed from high intakes.</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container my-5 py-5">
            <div class="row row-cols-lg-2 row-cols-md-1 row-cols-sm-1 row-cols-1">
                <div class="col w-100">
                    ...
                    <p class="fs-5">Pantothenic acid is found in almost all plant and animal foods to some degree, because the vitamin is found in all living cells. The best sources are beef, chicken, organ meats, fortified cereals, and some vegetables. </p>
                </div>
                <div class="col">
                    <ul class="fs-5" >
        ...
        <div class="container">
            <div class="row row-cols-lg-1 row-cols-md-1 row-cols-sm-1 row-cols-1">
                ...
                <div class="col w-75 mt-5 m-auto border border-2 border-success rounded"  style="background-color:  rgb(245, 245, 245);" >
                    ...
                    <p style="font-size: 18px;">Because pantothenic acid is found in a wide variety of foods, a deficiency is rare except in people who have other nutrient deficiencies, as seen with severe malnutrition. Other rare cases are seen in persons with genetic mutations in which pantothenic acid cannot be metabolized. <br><br>

                        Symptoms of deficiency may include:</p>
                    ...
                    <ul>
                        ...
                        <li>Nausea, vomiting, stomach cramps</li>
                        <li>Numbness or burning sensation in hands or feet</li>
                        <li>Muscle cramps</li>
                        
                    </ul>
                    <h5 class="mt-4"><b>Toxicity</b></h5>
                    <p style="font-size: 18px;">A toxic level of pantothenic acid has not been observed from food sources. With very large daily doses of 10 grams a day, stomach upset or mild diarrhea has been reported. [2] However, this is rare and a Tolerable Upper Intake Level for pantothenic acid has not been established.</p>
                </div>
            </div>
        </div>
