<%-- 
    Document   : Recipie17
    Created on : Nov 28, 2023, 12:13:43 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">Baby Kale Breakfast Salad with Quinoa & Strawberries</h2>
            <p class="fs-5 mt-4">Fruit, whole grains and greens for breakfast? Yes! Start your day off right with this breakfast salad recipe and you'll knock out half of your daily veggie quota with the first meal of the day.</p>

            <img class="img-fluid mt-5 h-30" src="images/Recipe17.webp" alt="" width="50%" height="300px" style="overflow: hidden;">
            <div class="col w-50 p-5 mt-5" style="background-color: rgb(228,241,239);">
              ...
              <span class="mt-4">1 Serving</span><hr>
              ...
              <ul class="list-inline " >
                ...
                <li class="list-inline-item" id="items"><a href="#">Low-Sodium</a></li>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul fs-5">
                ...
                <li>3 cups lightly packed baby kale</li>
                <li>½ cup cooked quinoa</li>
                <li>½ cup sliced strawberries</li>
                <li>1 tablespoon salted pepitas</li>
            </ul>
            <h2 class="fw-bold mt-5">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Mash garlic and salt together with the side of a chef's knife or a fork to form a paste. Whisk the garlic paste, oil, vinegar and pepper together in a medium bowl. Add kale; toss to coat. Serve topped with quinoa, strawberries and pepitas.</p>
            <h5 class="mt-4 fw-bold">Step 2 </h5>
            <p class="fs-5">Spread lettuce evenly over a large platter; top with chicken and avocado. Drizzle evenly with blended pico de gallo and remaining 1/4 cup pico de gallo. Sprinkle with tortilla chips and pepper.
            ...
            <span class="mt-4 fw-bold me-5">330</span>
            <span class="mt-4 fw-bold me-5 ms-5">20g</span>
            <span class="mt-4 fw-bold ms-5">31g</span>
            <span class="mt-4 fw-bold ms-5 ps-2">9g</span> <br>
