<%-- 
    Document   : Recipie3
    Created on : Nov 28, 2023, 12:08:18 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">Roasted Veggie Mason Jar Salad</h2>
            <p class="fs-5 mt-4">This vegan mason jar salad is easy to pack up and take for lunch. Layering the creamy cashew sauce into the bottom of the jar ensures that your big, bold power salad won't become wilted by the time you're ready to eat.</p>

            <img class="img-fluid mt-5 h-30" src="images/Recipe3.webp" alt="" width="50%" height="300px" style="overflow: hidden;">
            <div class="col w-50 p-5 mt-5" style="background-color: rgb(228,241,239);">
              ...
              <ul class="list-inline " >
                <li class="list-inline-item" id="items"><a href="#">High-Calcium</a></li>
                <li class="list-inline-item" id="items"><a href="#">Bone-Health</a></li>
  ...
  <div class="container my-5  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul fs-5">
                <li>2 tablespoons Creamy Vegan Cashew Sauce (see associated recipes)</li>
                <li>1 cup roasted tofu (see associated recipes)</li>
                <li>1 tablespoon pumpkin seeds</li>
                <li>1 cup roasted vegetables (see associated recipes)</li>
                <li>2 cups mixed greens</li>
            </ul>
            <h2 class="fw-bold mt-5">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Layer into a 4-cup jar, in this order: sauce, tofu, pumpkin seeds, veggies and greens. Close tightly and refrigerate for up to 5 days.</p>
            ...
            <p class="fs-5 mt-5">Originally appeared: EatingWell.com, December 2017</p>
            ...
            <span class="mt-4 fw-bold me-5">400</span>
            <span class="mt-4 fw-bold me-5 ms-5">27g</span>
            <span class="mt-4 fw-bold ms-5">21g</span>
            <span class="mt-4 fw-bold ms-5 ps-2">27g</span> <br>
