<%-- 
    Document   : This2
    Created on : Nov 28, 2023, 12:23:57 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Caramel Apple–Inspired Overnight Oats Taste Like Dessert for Breakfast</h2>
            <p class="fs-5">This easy, meal-prep-friendly recipe takes all the flavors of a caramel apple and imparts them into breakfast. Applesauce ensures the texture is creamy yet light while also providing balance to the sweet-tart flavor of the oats. If you don’t have Granny Smith apples on hand, Fuji, Gala or Honeycrisp apples work as well. Crushed honey-roasted peanuts mimic the coating of a caramel apple, but any salty-sweet nut would be delicious.</p>
            <img class="img-fluid" src="https://www.eatingwell.com/thmb/2YacJj36aBZTrqao5ciRHqXuI8A=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/Caramel-Apple-Inspired-Overnight-Oats_step_001-6c2b83664b724a339b9d29223be1e158.jpg" alt="">
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              ...
              <li>2 cups chopped unpeeled Granny Smith apples, divided</li>
              <li>1 cup unsweetened applesauce</li>
              <li>2 tablespoons caramel sauce, divideds</li>
            ...
            <p class="fs-5">Stir oats, almond milk, 1 cup apples, applesauce, 1 tablespoon caramel sauce, chia seeds, vanilla and honey together in a medium bowl until evenly combined.</p>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        ...
        <div class="col w-75 p-5" style="background-color: rgb(228,241,239);">
          ...
          <p class="fs-5"> 
            ...
            <br><br>
            Prepare through Step 2 and refrigerate for up to 4 days. Proceed with Step 3 when ready to serve.</p>
        </div>
    </div>
  </div>
