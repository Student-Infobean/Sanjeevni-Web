<%-- 
    Document   : Lu11
    Created on : Nov 27, 2023, 11:52:39 PM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Fiber-Packed Spicy White Bean & Spinach Salad</h2>
            <p class="fs-5">In this light and refreshing salad, we season white beans with ras el hanout, a Moroccan spice blend which features cinnamon, cumin, turmeric, ginger, cardamom and ground black and red pepper. If you prefer a creamier texture, gently mash some of the beans as you stir everything together. The bean salad is served on a bed of lightly dressed spinach that pairs well with the beans, but also grilled chicken or steak kebabs on another night.</p>
            <img class="img-fluid" src="images/L29.webp" width="50%" alt="">
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              ...
              <li>⅓ cup whole-milk plain yogurt</li>
              <li>¾ teaspoon ras el hanout</li>
              <li>½ teaspoon refrigerated garlic paste</li>
             <li>½ teaspoon salt</li>
             ...
             <li>¼ cup unsalted roasted almonds, chopped</li>
             <li>3 tablespoons golden raisins</li>
            </ul>
            <h2 class="fw-bold">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Combine beans, yogurt, ras el hanout, garlic paste, salt and honey in a medium bowl; stir to incorporate, coarsely mashing beans, if desired.</p>
    
            <h5 class="mt-4 fw-bold">Step 2 </h5>
            <p class="fs-5">Whisk oil, vinegar and harissa together in a large bowl. Add spinach, carrots, almonds and raisins; toss to coat. Serve the spinach mixture with the bean salad.</p>
