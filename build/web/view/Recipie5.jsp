<%-- 
    Document   : Recipie5
    Created on : Nov 28, 2023, 12:09:30 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">Pear, Gorgonzola & Walnut Salad</h2>
            <p class="fs-5 mt-4">This pear and gorgonzola salad celebrates fall with its beautiful colors. The light and refreshing vinaigrette offsets the tangy funk of Gorgonzola and the sweetness from the raisins and pears.</p>

            <img class="img-fluid mt-5 h-30" src="images/Recipe5.webp" alt="" width="50%" height="300px" style="overflow: hidden;">
            <div class="col w-50 p-5 mt-5" style="background-color: rgb(228,241,239);">
              ...
              <span class="mt-4">6 servings</span><hr>
              <p class="fs-5 fw-bold">Nutritional Profile:<br><br></p>
              <ul class="list-inline " >
                <li id="items" class="list-inline-item"><a href="#" >Low Added-sugar</a></li>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul fs-5">
                ...
                <li>4 cups mixed baby lettuces</li>
                <li>1 medium ripe Bosc pear, thinly sliced</li>
                <li>¼ cup crumbled Gorgonzola cheese</li>
                <li>¼ cup toasted walnuts, coarsely chopped</li>
                <li>¼ cup golden raisins</li>
            </ul>
            <h2 class="fw-bold mt-5">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Whisk together oil, lemon juice, honey, thyme, mustard, pepper and salt in a large bowl. Add lettuce and gently toss to combine. Top with sliced pear, Gorgonzola, walnuts and raisins. Serve immediately.</p>
            ...
            <span class="mt-4 fw-bold me-5">207</span>
            <span class="mt-4 fw-bold me-5 ms-5">14g</span>
            <span class="mt-4 fw-bold ms-5">21g</span>
            <span class="mt-4 fw-bold ms-5 ps-2">4g</span> <br>
