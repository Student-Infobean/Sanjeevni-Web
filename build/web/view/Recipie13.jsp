<%-- 
    Document   : Recipie13
    Created on : Nov 28, 2023, 12:12:17 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">Quinoa Chickpea Salad with Roasted Red Pepper Hummus Dressing</h2>
            <p class="fs-5 mt-4">This hearty vegan salad is loaded with plant-based power ingredients: chickpeas, quinoa and hummus. We love the crunch of the sunflower seeds and the unexpected flavor of roasted peppers.</p>

            <img class="img-fluid mt-5 h-30" src="images/Recipe13.webp" alt="" width="50%" height="300px" style="overflow: hidden;">
            <div class="col w-50 p-5 mt-5" style="background-color: rgb(228,241,239);">
              ...
              <span class="mt-4">3 1/2 cups</span><hr>
  ...
  <div class="container my-5  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul fs-5">
                <li>2 tablespoons hummus, original or roasted red pepper flavor</li>
                <li>1 tablespoon lemon juice</li>
                <li>1 tablespoon chopped roasted red pepper</li>
                <li>2 cups mixed salad greens</li>
                <li>½ cup cooked quinoa</li>
                <li>½ cup chickpeas, rinsed</li>
                <li>1 tablespoon unsalted sunflower seeds</li>
            ...
            <p class="fs-5">Stir hummus, lemon juice and red peppers in a small dish. Thin with water to desired consistency for dressing.

            </p>
            <h5 class="mt-4 fw-bold">Step 2 </h5>
            <p class="fs-5">Arrange greens, quinoa and chickpeas in a large bowl. Top with sunflower seeds, parsley, salt and pepper. Serve with the dressing.</p>
