<%-- 
    Document   : Lu15
    Created on : Nov 27, 2023, 11:53:58 PM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Spring Roll Salad</h2>
            <p class="fs-5">All the tastes, color and fun of a spring roll without all the work! This healthy salad recipe is bursting with the colors of rainbow from generous amounts of fresh vegetables, shrimp and whole grains all topped with a peanut dressing for the ultimate satisfying salad.</p>
            <img class="img-fluid" src="images/L33.webp" width="50%" alt="">
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              <li>1 tablespoon smooth natural peanut butter</li>
              <li>1 ½ teaspoons sesame oil</li>
              <li>1 ½ teaspoons rice vinegar</li>
              <li>1 teaspoon maple syrup</li>
             <li>1 teaspoon tamari or soy sauce
            </li>
             <li>1 teaspoon water
            </li>
             <li>½ teaspoon minced garlic
            </li>
             <li>Pinch of crushed red pepper (optional)
            </li>
             <li>3 cups torn Boston or butter lettuce</li>
             <li>3 ounces cooked shrimp</li>
            <li>½ cup cooked brown rice            </li>
            <li>¼ cup chopped red cabbage
            </li>
            <li>¼ cup julienned bell pepper
            </li>
            <li>¼ cup julienned carrots
            </li>
            <li>¼ cup julienned cucumber
            </li>
            <li>¼ cup avocado
            </li>
            <li>Fresh mint and sesame seeds for garnish</li>
        </ul>
            <h2 class="fw-bold">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Whisk peanut butter, oil, rice vinegar, maple syrup, tamari (or soy sauce), water, garlic and crushed red pepper (if using) in a small bowl until smooth. </p>
    
            <h5 class="mt-4 fw-bold">Step 2 </h5>
            <p class="fs-5">Combine lettuce, shrimp, rice, cabbage, bell pepper, carrot, cucumber and avocado in a bowl. Add dressing and toss to combine. Garnish with mint and sesame seeds, if desired. </p>
