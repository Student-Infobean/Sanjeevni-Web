<%-- 
    Document   : Recipie16
    Created on : Nov 28, 2023, 12:13:23 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">Shredded Chicken & Avocado Nacho Salad</h2>
            <p class="fs-5 mt-4">Dinner doesn't get any easier than this five-ingredient salad. And it's bursting with Super Bowl Sunday potential.</p>

            <img class="img-fluid mt-5 h-30" src="images/Recipe16.webp" alt="" width="50%" height="300px" style="overflow: hidden;">
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul fs-5">
                ...
                <li>6 cups coarsely chopped iceberg lettuce</li>
                <li>2 cups shredded skinless, boneless rotisserie chicken breast</li>
                <li>2 ripe peeled avocados, sliced</li>
                <li>2 ounces multigrain tortilla chips (about 20 chips)</li>
                <li>¼ teaspoon freshly ground black pepper</li>
            
            </ul>
            <h2 class="fw-bold mt-5">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Combine 1/2 cup pico de gallo and oil in a mini food processor; process until smooth. Set aside.
            ...
            <span class="mt-4 fw-bold me-5">412</span>
            <span class="mt-4 fw-bold me-5 ms-5">26g</span>
            <span class="mt-4 fw-bold ms-5">25g</span>
