<%-- 
    Document   : Thise30
    Created on : Nov 28, 2023, 12:33:00 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Lemon-Garlic Cabbage Wedges</h2>
            <p class="fs-5">Cabbage wedges roast in the oven, then are slathered with a lemon- and garlic-infused butter that seeps into the crevices of each leaf. Using a hot pan helps jump-start the cooking process and deepens the flavor by caramelizing the cabbage wedges as they hit the pan.</p>
            <img class="img-fluid" src="https://www.eatingwell.com/thmb/PH9Yn_VQ_ziav2SlQDZBMkQk-QY=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/Lemon-Garlic-Cabbage-Wedges-beauty-01-314e32191e6c4e5392c7fad87d5268fa.jpg" alt="">
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <p class="fs-5">Line a large rimmed baking sheet with foil; place in oven. Preheat the oven to 400°F. Remove any wilted or damaged leaves from cabbage. Cut the cabbage into 8 (1 1/4-inch) wedges, leaving the root end intact to help the wedges stay together.
            ...
            <p class="fs-5">Brush both sides of the cabbage wedges with oil and lemon juice; sprinkle with salt.
            </p>
            ...
            <p class="fs-5">Remove the baking sheet from the oven; arrange the cabbage wedges on it in a single layer. Roast until tender and slightly browned, 40 to 45 minutes, flipping halfway through. </p> 
            ...
            <p class="fs-5">Melt butter in a small saucepan over medium heat, about 1 minute. Stir in lemon zest, garlic, garlic salt and lemon-pepper. Spoon or brush the mixture evenly over both sides of the roasted cabbage (about 1 1/2 teaspoons per side). Return the cabbage wedges to the oven; roast for 5 minutes more.
  </p> 
  <br>
