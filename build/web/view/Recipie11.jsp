<%-- 
    Document   : Recipie11
    Created on : Nov 28, 2023, 12:11:38 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">Avocado Tuna Salad</h2>
            <p class="fs-5 mt-4">Jazz up a can of tuna with this easy avocado tuna salad recipe. Silky avocado adds creaminess that's cut with a hit of acidity from lemon and a briny punch from feta cheese. Romaine hearts and cucumber offer refreshing crunch.</p>

            <img class="img-fluid mt-5 h-30" src="images/Recipe11.webp" alt="" width="50%" height="300px" style="overflow: hidden;">
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul fs-5">
                ...
                <li>¼ teaspoon salt</li>
                <li>2 medium avocados, chopped (about 2 1/2 cups)</li>
                <li>2 (5 ounce) cans solid white tuna in oil, drained and flaked</li>
                <li>4 cups romaine hearts</li>
                <li>1 cup chopped English cucumber</li>
                <li>⅓ cup crumbled feta cheese</li>
                <li>¼ cup toasted sliced almonds</li>
            ...
            <p class="fs-5">Whisk oil, lemon juice and salt together in a large bowl; add avocados and toss gently to coat thoroughly. Add tuna, romaine, cucumber, feta, almonds, olives and parsley to the avocado mixture; toss gently to combine. Serve immediately or refrigerate for up to 1 hour.</p>
            ...
            <span class="mt-4 fw-bold me-5">338</span>
            <span class="mt-4 fw-bold me-5 ms-5">27g</span>
            <span class="mt-4 fw-bold ms-5">10g</span>
            <span class="mt-4 fw-bold ms-5 ps-2">17g</span> <br>
