<%-- 
    Document   : Lu7
    Created on : Nov 27, 2023, 11:51:14 PM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Green Goddess Wrap</h2>
            <p class="fs-5">A soft and silky green goddess dressing blends with crunchy fresh cucumber and tender greens in this easy wrap. If you prefer, you can ditch the wrap and enjoy the filling as a salad instead.</p>
            <img class="img-fluid" src="images/L25.webp" width="50%" alt="">
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              <li>¼ cup reduced-fat plain strained (Greek-style) yogurt</li>
              ...
              <li>¼ teaspoon salt</li>
              <li>1 cup baby spring mix salad greens</li>
              <li>1 scallion</li>
              <li>2 (8-inch) whole-wheat tortillas</li>
              <li>2 Persian cucumbers, unpeeled and cut into 4-by-1/4-inch strips</li>
              <li>½ cup alfalfa sprouts, divided</li>
              <li>1 medium avocado, sliced (1/4-inch), divided </li>
            </ul>
            <h2 class="fw-bold">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Combine yogurt, water, parsley, chives, dill, capers, garlic, lemon juice and salt in a mini food processor; process until smooth, about 2 minutes, stopping to scrape down sides of bowl as needed. Transfer to a small bowl. </p>
    
            <h5 class="mt-4 fw-bold">Step 2 </h5>
            <p class="fs-5">Toss salad greens with 2 tablespoons dressing in a medium bowl.</p>
           
            <h5 class="mt-4 fw-bold">Step 3 </h5>
            <p class="fs-5">Thinly slice dark green part of scallion. (Reserve white and light green parts for another use.) Place tortillas on a clean work surface. Spread 2 tablespoons dressing on each tortilla. Top with cucumbers, sprouts, scallion slices, avocado slices and dressed greens. Tightly roll the tortillas into wraps. Cut the wraps in half to serve. </p>
