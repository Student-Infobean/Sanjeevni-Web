<%-- 
    Document   : Thise36
    Created on : Nov 28, 2023, 12:34:52 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Cheesy Baked Brussels Sprouts</h2>
            <p class="fs-5">This creamy, cheesy baked Brussels sprout gratin will convince even the pickiest of eaters to gobble down their veggies. Gruyère cheese adds richness and flavor, while the panko adds a little crunch on top.</p>
            <img class="img-fluid" src="https://www.eatingwell.com/thmb/zGqLyeta7Se_sSDoGdhNXw_DxaQ=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/cheesy-baked-brussel-sprouts-2000-8bb97edee8e24ad38f38e651090cd225.jpg" alt="">
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              <li>2 pounds fresh Brussels sprouts, trimmed and halved (quartered if large)</li>
              <li>2 tablespoons water</li>
              <li>2 teaspoons minced garlic</li>
              <li>2 thyme sprigs, plus thyme leaves for garnish</li>
            ...
            <p class="fs-5">Preheat oven to 375°F. Coat a 2-quart baking dish with cooking spray. Place Brussels sprouts and water in a microwaveable bowl. Cover and microwave on High until tender-crisp, 5 to 7 minutes, depending on the size of your sprouts. Drain well. Transfer to the prepared baking dish.
            ...
            <p class="fs-5">Toss panko with the remaining 1 ½ teaspoons oil in a small bowl. Sprinkle evenly over the mixture in the baking dish. Bake until golden brown and bubbly, 20 to 25 minutes. Garnish with thyme leaves, if desired, and serve immediately.
            </p>  
             <img class="img-fluid" src="https://www.eatingwell.com/thmb/zGqLyeta7Se_sSDoGdhNXw_DxaQ=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/cheesy-baked-brussel-sprouts-2000-8bb97edee8e24ad38f38e651090cd225.jpg" alt="">  
             <!-- <br>
    ...
    <div class="container-fluid">
        <div class="row row-cols-lg-4 row-cols-md-2 row-cols-1">
          <div class="col  ms-5 fw-bold  w-100">
            ...
            <div class="col">  
            <div class="card">
                <a href="Thise25.jsp" class="cap text-decoration-none">
                    <img class="img-fluid p-3" src="https://www.eatingwell.com/thmb/WqmWum49vE4PwWuov-mdFNUzJc0=/282x188/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/AutumnSalad-3x2-121-064fb168762b48648f688a086e580ad9.jpg" alt="">
                        <div class="card-body">
