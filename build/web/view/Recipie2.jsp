<%-- 
    Document   : Recipie2
    Created on : Nov 28, 2023, 12:07:59 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">Chopped Chicken & Sweet Potato Salad</h2>
            <p class="fs-5 mt-4">This easy salad recipe allows for a wonderful use of leftover cooked chicken. Look for escarole in the produce section near the leafy greens; if you can't find it, you can use romaine instead.</p>

            <img class="img-fluid mt-5 h-30" src="images/Recipe2.webp" alt="" width="50%" height="300px" style="overflow: hidden;">
            <div class="col w-50 p-5 mt-5" style="background-color: rgb(228,241,239);">
              ...
              <span class="mt-4 me-5 pe-4" >10 mins</span>
              <span class="mt-4 me-5 ms-5 pe-5">10 mins</span>
              <span class="mt-4 ms-5">1</span> <br><br>
              <span class="mt-4 fw-bold me-5">Yield</span><br>
              <span class="mt-4">4 cups</span><hr>
              <p class="fs-5 fw-bold">Nutritional Profile:<br><br></p>
              <ul class="list-inline " >
                <li class="list-inline-item me-3" id="items"><a href="#">Diabetes-Appropriate</a></li>
                <li class="list-inline-item me-3" id="items"><a href="#">Nut-Free</a></li>
                <li class="list-inline-item me-3" id="items"><a href="#">Healthy Pregnancy</a></li>
                <li class="list-inline-item me-3" id="items"><a href="#">Healthy Aging</a></li>
                <li class="list-inline-item me-3" id="items"><a href="#">Healthy Immunity</a></li>
                <li class="list-inline-item me-3" id="items"><a href="#">Low-Sodium</a></li>
                <li class="list-inline-item me-3" id="items"><a href="#">Low Added Sugar</a></li>
                <li class="list-inline-item me-3" id="items"><a href="#">Soy-Free</a></li>
                <li class="list-inline-item me-3" id="items"><a href="#">High-Fiber</a></li>
                <li class="list-inline-item me-3" id="items"><a href="#">High-Protein</a></li>
                <li class="list-inline-item me-3" id="items"><a href="#">Egg-Free</a></li>
                <li class="list-inline-item me-3" id="items"><a href="#">Gluten-Free</a></li>
                <li class="list-inline-item me-3" id="items"><a href="#">Low-Calorie</a></li>
              </ul>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul fs-5">
                <li>3 cups coarsely chopped escarole or romaine lettuce</li>
                <li>½ cup cooked diced sweet potato</li>
                <li>3 ounces shredded cooked chicken</li>
                <li>¼ cup sliced apple</li>
                <li>2 tablespoons apple-cider vinaigrette (see Tip)</li>
                <li>¼ cup chopped avocado</li>
                <li>2 tablespoons roasted unsalted sunflower seeds</li>
                <li>½ ounce low-fat Cheddar cheese, cubed</li>
            </ul>
            <h2 class="fw-bold mt-5">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Toss escarole (or romaine), sweet potato, chicken, and apple with vinaigrette; place on a 9-inch plate.</p>
            <h5 class="mt-4 fw-bold">Step 2 </h5>
            <p class="fs-5">Top with avocado, sunflower seeds, and Cheddar.<p>
                <h2 class="fw-bold mt-5">Tips</h2>
                <p class="fs-5">Tip: To make a quick apple-cider vinaigrette, whisk 2 Tbsp. cider vinegar with 1/8 tsp. each salt and pepper. Slowly whisk in 1/4 cup extra-virgin olive oil until blended. Extra dressing will keep, covered, in the refrigerator for up to 5 days. Bring to room temperature before using.<p>
            <p class="fs-5 mt-5">Originally appeared: Diabetic Living Magazine, Spring 2019</p>
            ...
            <span class="mt-4 fw-bold me-5">542</span>
            <span class="mt-4 fw-bold me-5 ms-5">32g</span>
            <span class="mt-4 fw-bold ms-5">37g</span>
            <span class="mt-4 fw-bold ms-5 ps-2">37g</span> <br>
