<%-- 
    Document   : Recipie14
    Created on : Nov 28, 2023, 12:12:43 AM
    Author     : Lenovo
--%>
  ...
  <div class="container my-5  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <p class="fs-5 mt-4">This avocado chicken salad is herbaceous, bright and creamy. The blend of cilantro, dill and chives pairs nicely with fresh avocado. Enjoy this easy chicken salad over lettuce, on crackers or in a wrap.</p>

            <img class="img-fluid mt-5 h-30" src="images/Recipe14.webp" alt="" width="50%" height="300px" style="overflow: hidden;">
  ...
  <div class="container my-5  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul fs-5">
                <li>½ cup firmly packed fresh cilantro leaves and tender stems</li>
                <li>½ cup coarsely chopped fresh chives, plus more for garnish</li>
                <li>¼ cup firmly packed fresh dill fronds</li>
                <li>1 tablespoon drained capers</li>
                <li>1 teaspoon lemon zest, plus more for garnish</li>
                <li>1 tablespoon lemon juice</li>
                <li>2 cloves garlic</li>
                <li>¾ teaspoon salt</li>
                <li>½ teaspoon ground pepper</li>
                <li>2 ripe avocados, halved and pitted, divided</li>
                <li>⅓ cup mayonnaise</li>
                <li>¼ cup whole-milk plain strained yogurt (such as Greek-style)</li>
                <li>3 cups shredded cooked chicken breast</li>
            
            </ul>
            <h2 class="fw-bold mt-5">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Combine cilantro, chives, dill, capers, lemon zest, lemon juice, garlic salt, pepper and the flesh from 1 avocado in a food processor; process until finely chopped, about 30 seconds. Add mayonnaise and yogurt; process until smooth, 1 to 2 minutes.

            </p>
            <h5 class="mt-4 fw-bold">Step 2 </h5>
            <p class="fs-5">Dice the remaining avocado and place in a medium bowl. Add chicken and the dressing; stir gently until combined and evenly coated. Serve at room temperature or refrigerate until cold, about 2 hours. Garnish with additional chives and lemon zest, if desired.</p>
