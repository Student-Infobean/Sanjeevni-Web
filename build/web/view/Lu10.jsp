<%-- 
    Document   : Lu10
    Created on : Nov 27, 2023, 11:52:22 PM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Caprese Sandwich</h2>
            <p class="fs-5">This caprese sandwich is fresh from the basil and hearty from thick, crusty ciabatta. The sun-dried tomatoes deepen the flavor. Topping the bread with a layer of basil leaves and using toasted bread helps to keep the sandwich from getting soggy if you need to make it a few hours ahead.</p>
            <img class="img-fluid" src="images/L28.webp" width="50%" alt="">
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              <li>2 slices ciabatta, toasted</li>
              <li>¼ cup lightly packed fresh basil leaves</li>
              <li> 2 ounces mozzarella cheese, sliced</li>
              <li>2 slices tomato</li>
             <li>1 tablespoon chopped sun-dried tomatoes in oil
            </li>
             <li>1 teaspoon balsamic glaze</li>
            </ul>
            <h2 class="fw-bold">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Top 1 ciabatta slice with half of the basil leaves; top with mozzarella, tomato and sun-dried tomatoes. Drizzle with balsamic glaze and top with the remaining basil leaves and ciabatta slice. Cut in half diagonally and serve. </p>
