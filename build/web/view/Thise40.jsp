<%-- 
    Document   : Thise40
    Created on : Nov 28, 2023, 12:36:07 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Cheesy Vegetarian Stuffed Onions</h2>
            <p class="fs-5">Sweet and mild Vidalia onions are perfect for stuffing. Here, they are filled to the brim with a savory mushroom-bread filling to serve as an elegant side dish or appetizer. Any remaining onion scraps can be chopped and saved to add to hash the next morning or used in soup. Just be sure to refrigerate any onion scraps in an airtight container to keep their flavor and aroma contained.</p>
            <img class="img-fluid" src="https://www.eatingwell.com/thmb/zKZyvp4BrVjmwtV0Kwg3JFP1lf0=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/Cheesy-Vegetarian-Stuffed-Onions-2000-bb4e0a3300e34023902f6841b62794de.jpg" alt="">
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              <li>4 medium Vidalia onions (about 9 oz. each)</li>
              <li>1 cup water plus 2 tablespoons, divided</li>
              <li>1 ½ cups cubed whole-wheat bread</li>
              <li>1 tablespoon minced garlic</li>
             <li>½ cup shredded smoked Gouda cheese, divided</li>
             <!-- <li>1 ½ cups shredded extra-sharp Cheddar cheese, divided</li> -->
              <li>3 tablespoons reduced-fat cream cheese, softened</li>
              <li>2 teaspoons finely chopped fresh thyme, plus more for garnish</li>
              <li>¼ teaspoon ground pepper</li>
              <li>⅛ teaspoon salt</li>
            </ul>
            <h2 class="fw-bold">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Preheat oven to 450°F. Trim root end of each onion about 1/4-inch, keeping the root end intact. (This will help the onion sit flat in the pan and keep the filling inside.) Peel the onions. Cut off one-fourth of each onion top (on opposite end from root), leaving about a 3-inch-tall onion (discard onion tops or reserve for another use).
            ...
            <p class="fs-5">Using a melon baller or small spoon, carefully scrape and remove the inside of each onion, leaving the outer 1 to 2 layers intact and keeping the base slightly thicker; reserve 1 cup of the scooped onion scraps. (Discard the remaining onion scraps or reserve for another use.)   </p> 
            ...
            <p class="fs-5">Place the hollowed-out onions, open-sides up, in a 9-inch-square metal baking pan. Pour 1 cup water around the onions; cover the pan with foil. Bake until softened, about 20 minutes. Remove the foil; bake until the onions start to brown around the edges, 10 to 12 minutes more. Remove from the oven; carefully discard the hot water from the pan. Reduce oven temperature to 375°F.
