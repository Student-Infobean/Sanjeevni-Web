<%-- 
    Document   : Lu14
    Created on : Nov 27, 2023, 11:53:25 PM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5 border border-1  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold">Chickpea & Quinoa Grain Bowl</h2>
            <p class="fs-5">It seems grain bowls have as many variations as there are stars in the sky, and there is no wrong way to build one! But we prefer to keep things classic and simple with hummus, quinoa, avocado and loads of veggies!</p>
            <img class="img-fluid" src="images/L32.webp" width="50%" alt="">
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul">
              ...
              <li>⅓ cup canned chickpeas, rinsed and drained</li>
              <li>½ cup cucumber slices</li>
              <li>½ cup cherry tomatoes, halved</li>
             <li>¼ avocado, diced</li>
             <li>3 tablespoons hummus
            </li>
             <li>1 tablespoon finely chopped roasted red pepper
            </li>
             <li>1 tablespoon lemon juice
            </li>
             <li>1 tablespoon water, plus more if desired</li>
             <li>1 teaspoon chopped fresh parsley (Optional)</li>
            <li>Pinch of salt</li>
            <li>Pinch of ground pepper</li>
        </ul>
            <h2 class="fw-bold">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Arrange quinoa, chickpeas, cucumbers, tomatoes and avocado in a wide bowl.</p>
    
            <h5 class="mt-4 fw-bold">Step 2 </h5>
            <p class="fs-5">Stir hummus, roasted red pepper, lemon juice and water in a bowl. Add more water to reach desired consistency for dressing. Add parsley, salt and pepper and stir to combine. Serve with the Buddha bowl. </p>
