<%-- 
    Document   : Recipie15
    Created on : Nov 28, 2023, 12:13:03 AM
    Author     : Lenovo
--%>
    ...
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">
                Green Goddess Salad</h2>
            <p class="fs-5 mt-4">This gorgeous green goddess salad combines fresh shrimp, cucumber, artichoke hearts and cherry tomatoes with homemade dressing.</p>

            <img class="img-fluid mt-5 h-30" src="images/Recipe15.webp" alt="" width="50%" height="300px" style="overflow: hidden;">
            <div class="col w-50 p-5 mt-5" style="background-color: rgb(228,241,239);">
              ...
              <span class="mt-4 ms-5">4</span> <br><br>
              ...
              <ul class="list-inline " >
                ...
                <li class="list-inline-item" id="items"><a href="#">Healthy Aging</a></li>
                <li class="list-inline-item" id="items"><a href="#">Healthy Immunity</a></li>
                <li class="list-inline-item" id="items"><a href="#">Low Added Sugar</a></li>
  ...
  <div class="container my-5  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul fs-5">
                <li>½ avocado, peeled and pitted</li>
                <li>¾ cup nonfat buttermilk</li>
                <li>2 tablespoons chopped fresh herbs, such as tarragon, sorrel and/or chives</li>
                <li>2 teaspoons tarragon vinegar, or white-wine vinegar</li>
                <li>1 teaspoon anchovy paste, or minced anchovy fillet</li>
                <li>8 cups bite-size pieces green leaf lettuce</li>
                <li>12 ounces peeled and deveined cooked shrimp, (21-25 per pound; see Ingredient note)</li>
                <li>½ cucumber, sliced</li>
                <li>1 cup cherry or grape tomatoes</li>
                <li>1 cup canned chickpeas, rinsed</li>
                <li>1 cup rinsed and chopped canned artichoke hearts</li>
                <li>½ cup chopped celery</li>
            
            </ul>
            <h2 class="fw-bold mt-5">Directions</h2>
            <h5 class="mt-4 fw-bold">Step 1 </h5>
            <p class="fs-5">Puree avocado, buttermilk, herbs, vinegar and anchovy in a blender until smooth.

            </p>
            <h5 class="mt-4 fw-bold">Step 2 </h5>
            <p class="fs-5">Divide lettuce among 4 plates. Top with shrimp, cucumber, tomatoes, chickpeas, artichoke hearts and celery. Drizzle the dressing over the salads.</p>
             <!-- <h2 class="mt-4 fw-bold">To make ahead</h2>
            <p class="fs-5">Refrigerate for up to 2 days.<p> -->
                <h2 class="mt-4 fw-bold">Equipment</h2>
                <p class="fs-5">Blender<p>
            ...
            <p class="fs-5">Based on earlier reviews and comments of this recipe, we've retested and made the following adjustment: <br><br>We increased the amount of vinegar and oil to yield more dressing.<p> -->
                <h2 class="fw-bold mt-5">Ingredient note</h2>
                <p class="fs-5">Shrimp are sold by the number needed to make one pound. For example, "21-25 count" means there will be 21 to 25 shrimp in a pound. Size names, such as "large" or "extra large," are not standardized, so to be sure you're getting the size you want, order by the count (or number) per pound.<p>
            ...
            <span class="mt-4 fw-bold me-5">262</span>
            <span class="mt-4 fw-bold me-5 ms-5">6g</span>
            <span class="mt-4 fw-bold ms-5">31g</span>
            <span class="mt-4 fw-bold ms-5 ps-2">22g</span> <br>
