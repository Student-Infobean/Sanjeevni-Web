<%-- 
    Document   : Recipie8
    Created on : Nov 28, 2023, 12:10:37 AM
    Author     : Lenovo
--%>
...
<body>
  ...
  <div class="container my-5  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            <h2 class="fw-bold mt-4">Mixed Greens with Lentils & Sliced Apple</h2>
            <p class="fs-5 mt-4">This salad with lentils, feta and apple is a satisfying vegetarian entree to whip together for lunch. To save time, swap in drained canned lentils--just make sure to look for low-sodium and give them a rinse before adding them to the salad.</p>

            <img class="img-fluid mt-5 h-30" src="images/Recipe8.webp" alt="" width="50%" height="300px" style="overflow: hidden;">
  ...
  <div class="container my-5  w-75">
    <div class="row row-cols-lg-1 row-cols-1">
        <div class="col w-100">
            ...
            <ul class="ul fs-5">
                <li>1 ½ cups mixed salad greens</li>
                <li>½ cup cooked lentils</li>
                <li>1 apple, cored and sliced, divided</li>
                <li>1 ½ tablespoons crumbled feta cheese</li>
            ...
            <p class="fs-5">Top greens with lentils, about half the apple slices and the feta. Drizzle with vinegar and oil. Serve with the remaining apple slices on the side.</p>
            ...
            <span class="mt-4 fw-bold me-5">347</span>
            <span class="mt-4 fw-bold me-5 ms-5">13g</span>
            <span class="mt-4 fw-bold ms-5">48g</span>
