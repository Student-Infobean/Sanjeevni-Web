<%-- 
    Document   : ADHD
    Created on : Nov 27, 2023, 10:49:09 PM
    Author     : Lenovo
--%>
            ...
            <div class="row  row-cols-lg-2 row-cols-md-2 row-cols-sm-1">
                ...
                <div class="card">
                    <a href="Brain_2.html" class="cap text-decoration-none">    
                        <img class="img-fluid p-3" src="https://www.verywellmind.com/thmb/x2kOwkb3-ZEaEhDCYT46Kcbd-uc=/550x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/GettyImages-763164379-6e558479d5464e758233cd61a6b4561b.jpg" alt="">
                            <div class="card-body">
                                <!-- <p class="card-text text-secondary fs-5">HEALTHY OAT RECIPES</p> -->
                                <h4 class="card-title fw-bold">
                                    Medication for ADHD
                                    ADHD Medication for Adults</h4>
